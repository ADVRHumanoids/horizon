...
def EULER(dae, opts=None, casadi_type=cs.SX):
    ...
    f_RK = cs.Function('f_RK', [x, qddot], [xdot, L], {"allow_free":True})
    ...
    f = cs.Function('F_RK', [X0_RK, U_RK, DT_RK], [X_RK, Q_RK], ['x', 'u', 'dt'], ['f', 'qf'], {"allow_free":True})
    return f
...
def LEAPFROG(dae, opts=None, casadi_type=cs.SX):
    ...
    f = cs.Function('F_RK', [X0_RK, X0_PREV_RK, U_RK, DT_RK], [X_RK, X_PREV_RK, Q_RK], ['x0', 'x0_prev', 'p', 'time'], ['xf', 'xf_prev', 'qf'], {"allow_free":True})
    return f
